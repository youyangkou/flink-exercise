 ...
 *IM触发无房监控优化
 */
public class ImMonitorOptimization_cache {

    static Cache<String, String> pattern_map = FlinkPropertyUtil.getMapFromDB("select * from xz_data_monitor.xz_im_monitor_pattern", "pattern_key", "pattern_value",1000,5);
                ...
                Pattern.<Tuple6<String,String,String,String,String,String>>
                        ...
                        new IterativeCondition<Tuple6<String,String,String,String,String,String>>() {
                            ...
                            public boolean filter(Tuple6<String, String, String, String, String, String> value, Context<Tuple6<String, String, String, String, String, String>> ctx) throws Exception {
                                String tenant_pattern_a = pattern_map.asMap().get("tenant_pattern_A");
                                if(StringUtil.isEmptyOrWhiteSpace(tenant_pattern_a)){
                                    System.out.println("缓存过期了");
                                    pattern_map = FlinkPropertyUtil.getMapFromDB("select * from xz_data_monitor.xz_im_monitor_pattern", "pattern_key", "pattern_value",1000,5);
                                    tenant_pattern_a = pattern_map.asMap().get("tenant_pattern_A");
                        ...
                        .where(new IterativeCondition<Tuple6<String,String,String,String,String,String>>() {
                            @Override
                            public boolean filter(Tuple6<String, String, String, String, String, String> value, Context<Tuple6<String, String, String, String, String, String>> ctx) throws Exception {
                                String landlord_pattern_1 = pattern_map.asMap().get("landlord_pattern_1");
                                String landlord_pattern_2 = pattern_map.asMap().get("landlord_pattern_2");
                                if(StringUtil.isEmptyOrWhiteSpace(landlord_pattern_1)||StringUtil.isEmptyOrWhiteSpace(landlord_pattern_2)){
                                    System.out.println("缓存过期了");
                                    pattern_map = FlinkPropertyUtil.getMapFromDB("select * from xz_data_monitor.xz_im_monitor_pattern", "pattern_key", "pattern_value",1000,5);
                                    landlord_pattern_1 = pattern_map.asMap().get("landlord_pattern_1");
                                    landlord_pattern_2 = pattern_map.asMap().get("landlord_pattern_2");
        ...
        Pattern<Tuple6<String,String,String,String,String,String>,Tuple6<String,String,String,String,String,String>> imPatternB =
                Pattern.<Tuple6<String,String,String,String,String,String>>
                        ...
                        new IterativeCondition<Tuple6<String,String,String,String,String,String>>() {
                            ...
                            public boolean filter(Tuple6<String, String, String, String, String, String> value, Context<Tuple6<String, String, String, String, String, String>> ctx) throws Exception {
                                String tenant_pattern_a = pattern_map.asMap().get("tenant_pattern_A");
                                String tenant_pattern_b = pattern_map.asMap().get("tenant_pattern_B");
                                if(StringUtil.isEmptyOrWhiteSpace(tenant_pattern_a)||StringUtil.isEmptyOrWhiteSpace(tenant_pattern_b)){
                                    System.out.println("缓存过期了");
                                    pattern_map = FlinkPropertyUtil.getMapFromDB("select * from xz_data_monitor.xz_im_monitor_pattern", "pattern_key", "pattern_value",1000,5);
                                    tenant_pattern_a = pattern_map.asMap().get("tenant_pattern_A");
                                    tenant_pattern_b = pattern_map.asMap().get("tenant_pattern_B");
                                    System.out.println(tenant_pattern_a);
                        ...
                        .where(new IterativeCondition<Tuple6<String,String,String,String,String,String>>() {
                            ...
                            public boolean filter(Tuple6<String, String, String, String, String, String> value, Context<Tuple6<String, String, String, String, String, String>> ctx) throws Exception {
                                ...
                                if(StringUtil.isEmptyOrWhiteSpace(landlord_pattern_1)||StringUtil.isEmptyOrWhiteSpace(landlord_pattern_2)){
                                    System.out.println("缓存过期了");
                                    String sql="select * from xz_data_monitor.xz_im_monitor_pattern";
                                    pattern_map = FlinkPropertyUtil.getMapFromDB("select * from xz_data_monitor.xz_im_monitor_pattern", "pattern_key", "pattern_value",1000,5);
                                    landlord_pattern_1 = pattern_map.asMap().get("landlord_pattern_1");
                                    landlord_pattern_2 = pattern_map.asMap().get("landlord_pattern_2");
                                    System.out.println(landlord_pattern_1);
